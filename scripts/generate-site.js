  ...
  <section class="hero">
    <div class="hero-copy reveal">
      ...
      <div class="hero-actions">
        ...
        <a class="button secondary" href="resume/">Resume showcase</a>
      </div>
...
function resumePage() {
  const body = `<section class="page-hero">
    ...
    <div class="hero-actions"><a class="button primary" href="javascript:window.print()">Print or save as PDF</a><a class="button secondary" href="mailto:${email}">Contact</a></div>
  </section>
...
- \`resume/\` - printable resume showcase
